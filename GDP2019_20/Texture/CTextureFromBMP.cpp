...
//					 this->m_p_theImages );
	...
	//glTexParameteri(GL_TEXTURE_2D, GL _TEXTURE_MAG_FILTER, GL_NEAREST /*GL_LINEAR*/);
...
bool CTextureFromBMP::CreateTextureFromBMPFile(std::string textureName, std::string fileNameFullPath)
{
	if (!this->LoadBMP2(fileNameFullPath))
	{
		return false;
...
bool CTextureFromBMP::LoadToGPU(bool generateMipMap)
{
	bool bReturnVal = true;
